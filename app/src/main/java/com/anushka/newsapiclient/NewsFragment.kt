...
class NewsFragment : Fragment() {
    ...
    private fun setSearchView() {
        fragmentNewsBinding.svNewsFragment.setOnQueryTextListener(object :
        ...
        fragmentNewsBinding.svNewsFragment.setOnCloseListener(object : SearchView.OnCloseListener {
